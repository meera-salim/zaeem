...
<nav class="relative container mx-auto p-6">
    <div class="flex items-center justify-between">
        <div class="pt-1">
            <img src="/manage-app/logo.svg" alt="">
        </div>
...
<section id="hero">
    ...
    <div class="container flex flex-col-reverse md:flex-row items-center px-6 mx-auto mt-10 space-y-0 ">
        ...
        <div class="md:w-1/2">
           <img src="manage-app/illustration-intro.svg" alt="">
        </div>
    </div>
    ...
    <div class="flex flex-col space-y-8 md:w-1/2">
        <div class="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
            ...
            <div>
                ...
                <p class="text-darkGrayishBlue">See how your day-to-day tasks fit into the wider vision. Go from
 ...
 <div class="max-w-6xl px-5 mx-auto mt-32 text-center">
    ...
    <!-- Testimonials Container -->
     <div class="flex flex-col mt-24 md:flex-row md:space-x-6">
        ...
        <img src="manage-app/avatar-anisha.png" class="w-16 -mt-14" alt="">
        <h5 class="text-lg font-bold">Anisha Lee</h5>
        <p class="text-sm text-darkGrayishBlue">“Manage has supercharged our team’s workflow. The ability to
        ...
        <div class="hidden  flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:flex md:w-1/3">
            <img src="manage-app/avatar-ali.png" class="w-16 -mt-14" alt="">
            <h5 class="text-lg font-bold">Ali Bravo</h5>
            <p class="text-sm text-darkGrayishBlue">“ “We have been able to cancel so many other subscriptions since
            ...
            <!-- Testimonial 3 -->
         <div class="hidden  flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:flex md:w-1/3">
            <img src="manage-app/avatar-richard.png" class="w-16 -mt-14" alt="">
 ...
 <footer class="bg-veryDarkBlue">
    <div class="container flex flex-col-reverse justify-between px-6 py-10 mx-auto space-y-8 md:flex-row md:space-y-0">
        <div class="flex flex-col-reverse items-center justify-between space-y-12 md:flex-col md:space-y-0 md:items-start">
            <div>
                <img src="manage-app/logo.svg" alt="" class="h-8 mt-5">
            </div>
            <div class="flex justify-center space-x-4">
                <a href="#">
                    <img src="manage-app/icon-facebook.svg" alt="" class="h-8">
                </a>
                <a href="#">
                    <img src="manage-app/icon-youtube.svg" alt="" class="h-8">
                </a>
                <a href="#">
                    <img src="manage-app/icon-twitter.svg" alt="" class="h-8">
                </a>
                <a href="#">
                    <img src="manage-app/icon-pinterest.svg" alt="" class="h-8">
                </a>
                <a href="#">
                    <img src="manage-app/icon-instagram.svg" alt="" class="h-8">
                </a>
            </div>
        </div>
